...
public class Textbox
{
  ...
  public void draw( GraphicsHandler graphicsHandler)
  {
    ...
    if (!decideTurn.isEmpty() && ( selectionText[0] != null && decideTurn.peek().equals("1" ) ) )
    {
  ...
  public void update()
  {
    ...
    if (!textQueue.y() && keyLocker.isKeyLocked( interactKey) )
    {
    ...
    if ( Keyboard.isKeyDown( interactKey) && !keyLocker.isKeyLocked( interactKey) )
    {
      keyLocker.lockKey( interactKey);
      textQueue.poll();
      if (!decideTurn.isEmpty() && decideTurn.peek().equals("1" ) )
      {
    ...
    {
      if ( Keyboard.isKeyUp( interactKey) )
      {
    ...
    {
      if ( Keyboard.isKeyDown( Key.LEFT) && keyTimer.isTimeUp() && selectionText[0] != null )
      {
        keyTimer.reset();
