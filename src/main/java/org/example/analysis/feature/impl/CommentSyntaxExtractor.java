...
import org.example.analysis.StyleType.CommentSyntax;
...
public class CommentSyntaxExtractor extends StyleFeatureExtractor {
    @Override
    public void toFeatureVector(Style style, Map<String, StyleVector> st2svMap) {
        ...
        st2svMap.put(CommentSyntax.styleType, sv);
    }
}
