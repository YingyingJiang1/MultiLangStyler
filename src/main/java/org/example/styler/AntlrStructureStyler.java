 ...
 */
public class AntlrStructureStyler extends AntlrConcreteStylerBase {
  ...
  public ExtendContext applyStyle(ExtendContext ctx, ProgramStyle programStyle) {
    applySingleBlockStyle(ctx, programStyle);
    ++recursiveDepth;
    ParseTree newTree = ctx;
    try {
      EquivalencesStyle equivalencesStyle = (EquivalencesStyle) programStyle.getStyle(ProgramStyle.EQUIVALENCES);
        ...
        if(!matchedStructures.isEmpty()){
          ...
          while(it.hasNext()) {
            ...
            if(newTree instanceof ExtendContext newCtx) {
              ...
              applyStyle(newCtx, programStyle);
              break;
            }
          }
        }
   ...
   * @param programStyle
   */
  private void applySingleBlockStyle(ExtendContext ctx, ProgramStyle programStyle) {
