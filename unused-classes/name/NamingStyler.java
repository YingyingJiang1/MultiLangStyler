 ...
 */
public class NamingStyler extends StylerBase implements ASTStyler {
  private static NamingStyler instance = new NamingStyler();
  ...
  public NamingStyler() {}
  public static NamingStyler getInstance() {
    return instance;
  }
  ...
  public void extractStyle(ExtendContext ctx, Style style) {
    ...
    if (symbols != null) {
      NamingStyle namingStyle = (NamingStyle) style;
