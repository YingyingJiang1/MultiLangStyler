...
//				System.out.println(j);
				if ( j == 0 && ((int) ch - 1 == (int) sb.charAt(j + 1))) { sb.deleteCharAt(j);
					ans++;
					j -= 1;
					continue ; }  if ( j == sb.length() - 1 && ((int) ch - 1 == (int) sb.charAt(j - 1))) { sb.deleteCharAt(j);
					ans++;
					j -= 1;
					continue ; }  if ((j < sb.length() - 1 && (int) ch - 1 == (int) sb.charAt(j + 1))
